        ...
        <div className="ci-results" style={{ marginTop: 16, display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <SB mood={mood}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              <div style={{ fontSize: 15, fontWeight: 600 }}>🔄 Want an improved version of this script?</div>
            </div>
            <div style={{ fontSize: 12.5, color: 'var(--text-3)', margin: '6px 0 12px' }}>Tell us what direction to take (optional):</div>
            ...
            {rewrite.out && (
              <div style={{ marginTop: 14 }}>
                ...
                <div className="ci-copyblock" style={{ marginTop: 8, whiteSpace: 'pre-wrap', display: 'block' }}>
                  <div style={{ fontSize: 13.5, lineHeight: 1.6, color: 'var(--text-1)' }}>{rewrite.out}</div>
                </div>
              </div>
            )}
          </SB>
