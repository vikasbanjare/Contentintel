...
FOUNDER-INTERVIEW / BUSINESS PODCAST (host + guest case-study interviews) — observed style (n=12):
...
3. HOOK TEXT: ALL-CAPS bold sans with a big number (₹Cr / $M / "₹1 Cr/month") OR a sharp metric ("106X oversubscribed", "90% market share"). Frames: "HOW TO BUILD A ___?", "HOW [BRAND] BECAME ₹X?", "FROM ___ TO ___", or a first-person quote ("I make ₹650 Crores selling tickets").
4. The brand name is often highlighted in a coloured box (marker emphasis); add a "Ft. [name]" credit.
